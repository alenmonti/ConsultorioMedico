            ...
            <div class="card" id="main-card">
                ...
                <div id="step-3" class="hidden">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-input" id="input-wsp" type="tel" placeholder="Ej: +54 9 11 1234-5678" autocomplete="tel">
                        <div class="error-msg hidden" id="err-wsp">Ingresá tu número de WhatsApp.</div>
                    </div>
...
(function () {
    ...
    async function submitReserva() {
        ...
        if (!wsp) { show('err-wsp'); valid = false; }
        if (!valid) return;

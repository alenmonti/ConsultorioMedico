...
<head>
    ...
    <meta property="og:title" content="Consultorio Monti — Reservar turno">
    <meta property="og:description" content="Reservá tu turno online de forma rápida y sencilla.">
    <meta property="og:image" content="{{ asset('logo-long.jpg') }}">
    <meta property="og:type" content="website">
    <meta property="og:url" content="{{ url()->current() }}">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Consultorio Monti — Reservar turno">
    <meta name="twitter:description" content="Reservá tu turno online de forma rápida y sencilla.">
    <meta name="twitter:image" content="{{ asset('logo-long.jpg') }}">

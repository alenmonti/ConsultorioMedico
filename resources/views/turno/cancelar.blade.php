...
<head>
    ...
    <meta property="og:description" content="Tocá el link para ver los datos de tu turno y cancelarlo.">
    <style>
...
<body>
    <div class="card">
        ...
        <p class="subtitle">Revisá los datos de tu turno y cancelalo.</p>
        ...
        <form method="POST" action="{{ route('turno.cancelar.store', $turno->id) }}">
            @csrf
